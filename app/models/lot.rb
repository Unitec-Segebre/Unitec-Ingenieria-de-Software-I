class Lot < ApplicationRecord
  ...
  def getValue(name)
    ...
    hash = { name: var.name, unit_cost_mano: var.unit_cost_mano, unit_cost_insumo: var.unit_cost_insumo, amount: 0, cost_mano: 0, cost_insumo: 0, unit_cost_total: 0}
    unless value.nil?
      hash.merge!({ unit_cost_mano: value.unit_cost_mano, unit_cost_insumo: value.unit_cost_insumo, amount: value.amount, cost_mano: value.cost_mano, cost_insumo: value.cost_insumo, unit_cost_total: value.unit_cost_total })
    end
